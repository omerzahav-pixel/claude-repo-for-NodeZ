...
(function(){
  ...
  function ensure(){
    ...
    hdr.style.cssText='display:flex;align-items:center;gap:6px;padding:5px 8px;border-bottom:1px solid #333333;background:#181A1B;border-radius:7px 7px 0 0;font-weight:600;font-size:11px;flex-shrink:0;-webkit-user-select:none;user-select:none';
