...
function imF(e){const f=e.target.files[0];if(!f)return;const r=new FileReader();r.onload=()=>{sn();S=JSON.parse(r.result);reconcileCanvases();sv();render();bF();bB();renderTabs();renderSB()};r.readAsText(f)}
