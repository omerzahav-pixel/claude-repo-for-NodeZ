...
*Last updated 16 April 2026 · Status: Phase 2 complete · Phase 5 P1 complete (all 6 items) · Phase 5 P2 in progress (#1 selection glow · #2 expandable description · #3 redo · #4 workspace color · #5 paste-patch size sanity · #6 tooltips pass done) · Branch: v2-rewrite*
